...
public class AlarmReminderDbHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "alarmremindeer.db";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String SQL_CREATE_ALARM_TABLE =  "CREATE TABLE " + AlarmReminderContract.AlarmReminderEntry.TABLE_NAME + " ("
                ...
                + AlarmReminderContract.AlarmReminderEntry.KEY_START_POINT + " TEXT,"
                + AlarmReminderContract.AlarmReminderEntry.KEY_END_POINT + " TEXT, "
                + AlarmReminderContract.AlarmReminderEntry.KEY_NOTE + " TEXT " + " );";
