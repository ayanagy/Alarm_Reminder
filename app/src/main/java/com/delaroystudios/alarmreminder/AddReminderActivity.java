...
public class AddReminderActivity extends AppCompatActivity implements
    ...
    private EditText mTitleText,mNoteText;
    ...
    private static final String KEY_START_POINT = "start_point_key";
    private static final String KEY_END_POINT = "end_point_key";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StartTrip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mStart.equals(str) && mEnd.equals(str)) {


                    Toast.makeText(AddReminderActivity.this, "please select start & end point", Toast.LENGTH_LONG).show();


                } else {

                    Intent intent = new Intent(android.content.Intent.ACTION_VIEW,
                            Uri.parse("http://maps.google.com/maps?saddr=" + mStart + "&daddr=" + mEnd));//Dikirnis
        ...
        mNoteText=(EditText) findViewById(R.id.addNote);//note
       ...
       autocompleteFragment1.setHint("End Point ! ");
        ...
        mNoteText.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                mNote = s.toString().trim();
                mNoteText.setError(null);
            }
        ...
        tripFrom.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                 mStart= s.toString().trim();
                tripFrom.setError(null);
            }
        ...
        tripTo.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                mEnd= s.toString().trim();
                tripTo.setError(null);
            }
        ...
        if (savedInstanceState != null) {
            ...
            String savedNote = savedInstanceState.getString(KEY_NOTE);
            mNoteText.setText(savedNote);
            mNote = savedNote;


            String savedStartPoint = savedInstanceState.getString(KEY_START_POINT);
           tripFrom.setText(savedStartPoint );
            mStart = savedStartPoint ;


            String savedEndPoint = savedInstanceState.getString(KEY_END_POINT);
            tripTo.setText(savedEndPoint );
            mEnd = savedEndPoint ;
    ...
    protected void onSaveInstanceState (Bundle outState) {
        ...
        outState.putCharSequence(KEY_START_POINT,tripFrom.getText());
        outState.putCharSequence(KEY_END_POINT,tripTo.getText());
        outState.putCharSequence(KEY_NOTE,mNoteText.getText());
...
*/
        ...
        values.put(AlarmReminderContract.AlarmReminderEntry.KEY_START_POINT, mStart);
        values.put(AlarmReminderContract.AlarmReminderEntry.KEY_END_POINT, mEnd);
        values.put(AlarmReminderContract.AlarmReminderEntry.KEY_NOTE, mNote);
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        String[] projection = {
                ...
                AlarmReminderContract.AlarmReminderEntry.KEY_START_POINT,
                AlarmReminderContract.AlarmReminderEntry.KEY_END_POINT,
                AlarmReminderContract.AlarmReminderEntry.KEY_NOTE,
        };
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int startColumnIndex = cursor.getColumnIndex(AlarmReminderContract.AlarmReminderEntry.KEY_START_POINT);
            int endColumnIndex = cursor.getColumnIndex(AlarmReminderContract.AlarmReminderEntry.KEY_END_POINT);
            int noteColumnIndex = cursor.getColumnIndex(AlarmReminderContract.AlarmReminderEntry.KEY_NOTE);
